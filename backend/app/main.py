...
from app.api.routes import players, games, events, bets, teams
...
async def warmup_espn_cache():
    # Build roster cache in background so first search is fast and is_active is accurate
